...
/**
 * Core Product Details Engine execution logic.
 */
export async function executeProductDetailsEngine(supabase: any, productId: string) {
...
export const runProductDetailsEngine = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) => {
    return await executeProductDetailsEngine(context.supabase, data.productId);
  });
